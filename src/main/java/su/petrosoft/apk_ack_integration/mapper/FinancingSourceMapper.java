...
public class FinancingSourceMapper {
    ...
    public FinancingSource toEntity(UniBudgetExcelRow row) {
        return FinancingSource.builder()
    ...
    private String concatKBK(UniBudgetExcelRow row) {
        StringBuilder sb = new StringBuilder(LocalDateTime.now().getYear());
        sb.append("-");
        sb.append(row.kvsr());
