...
//                                new LinkedAttribute(RECIPIENT_ATTR, park.getRecipientId()),
                                ...
                                new LinkedAttribute(MACH_EQUIP_ATTR, getDictionaryIdByCode(codesMap, getType(park), park.getMachineryAndEquip())),
                                ...
                                new LinkedAttribute(PROD_COUNTRY_ATTR, getDictionaryIdByCode(codesMap, PROD_COUNTRY, park.getProductionCountry())),
                                new LongAttribute(PROD_YEAR_ATTR, park.getProductionYear()),
                                new BooleanAttribute(STATE_SUPPORT_ATTR, park.getStateSupport()),
                                new LinkedAttribute(TECH_STATE_ATTR, getDictionaryIdByCode(codesMap, TECH_STATE, park.getTechState()))
                        ))
                        .build());
    }
