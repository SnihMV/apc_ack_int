...
//                                new LinkedAttribute(RECIPIENT_ATTR, park.getRecipientId()),
                                ...
                                new LinkedAttribute(MACH_EQUIP_ATTR, getCodeId(codesMap, getType(park), park.getMachineryAndEquip())),
                                ...
                                new LinkedAttribute(PROD_COUNTRY_ATTR, getCodeId(codesMap, PROD_COUNTRY, park.getProductionCountry())),
                                new LongAttribute(PROD_YEAR_ATTR, park.getProductionYear()),
                                new BooleanAttribute(STATE_SUPPORT_ATTR, park.getStateSupport()),
                                new LinkedAttribute(TECH_STATE_ATTR, getCodeId(codesMap, TECH_STATE, park.getTechState()))
                        ))
                        .build());
    }
