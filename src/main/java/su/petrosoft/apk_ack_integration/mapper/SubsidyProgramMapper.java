...
public class SubsidyProgramMapper {
    ...
    public SubsidyProgram toFirstLevelSP(UniBudgetExcelRow dto) {
        return SubsidyProgram.builder()
                .level(1L)
                .code(dto.code())
    ...
    public SubsidyProgram toSecondLevelSP(UniBudgetExcelRow dto) {
        return SubsidyProgram.builder()
                .level(2L)
                .title(dto.kcsrTitle())
                .kcsr(dto.kcsr())
    ...
    public SubsidyProgram toThirdLevelSP(UniBudgetExcelRow dto) {
        return SubsidyProgram.builder()
                .level(3L)
