...
//                new StringAttribute(CODE_ATTR, sp.getCode()),
                ...
                new LinkedAttribute(KCSR_ATTR, dictionaryIdByCode(codesMap, KCSR, sp.getKcsr()))));
        if (sp.getLevel() == 2) {
            attributes.add(new LinkedAttribute(DOPKR_ATTR, dictionaryIdByCode(codesMap, DOPKR, sp.getDopKr())));
        }
