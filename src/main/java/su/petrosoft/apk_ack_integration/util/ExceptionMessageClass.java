...
public class ExceptionMessageClass {
    ...
    public static final String MISSING_IDENT_KEY = "Отсутствует идентификационное значение [%s]";
    public static final String MISMATCH_IDENT_VALUES = "Экземпляры не равны";
