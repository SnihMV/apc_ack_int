...
public class OperationalReportUtil {
    ...
    public static GetAttributesListRequestDto requestDtoForGettingOperationalReportsByTypeAndDate(
            ReportType reportType, long from) {
        return requestDtoForGettingOperationalReportsByTypeAndDateInterval(reportType, from, from);
    }
    public static GetAttributesListRequestDto requestDtoForGettingOperationalReportsByTypeAndDateInterval(
        ...
        return GetAttributesListRequestDto.builder()
                ...
                .filter(new Filter(List.of(
                        ...
                        new LinkedFilterAttribute(STATUS_ATTR, 5858),
                        new DateFilterAttribute(CURRENT_DATE_ATTR, List.of(SqlOperation.BETWEEN), from, to)
                )))
                .build();
    }
